...
Icons are supposed to be a visual representation of real world analogs but more and more these things are all becoming data. Data that represents data is kinda useless so icons have become abstract and non-sense to a lot of people. Think of the massive array of people that now have no clue what the save icon is? (5.25" Disks) So many real world analogs are gone now leaving computer metaphores abstract to many users. Who uses actual folders in real life anymore unless you have a cr4p office job? Sadly most UI is still white background black text? WHY? It chews battery on mobile and strains your eyes! Because the real world analog was white paper and black or blue ink...That is an analog that can kindly die in a fire...possibly a fire started by the garbage printers that still perpetuate this along with various other evils. (The older I get the more "Stallman" I get...and Richard Stallman is to Tech what Vegans are to food.)
